...
const adjustReload =(e:any)=>{
  ...
  return(
    ...
    <label htmlFor="min-reload">Minimum Reload Amount:{ onChangeRegTest ? true:<h1 className="text-red-400">Please Enter Only Numbers</h1>}
              <input className="shadow appearance-none border rounded w-fit py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black" name="min-Reload" pattern="^(0|[1-9][0-9]*)$"  onChange={e=>{adjustReload(e); props.reload}}/>
