...
const ScrapeInfoForm = () =>{
  ...
  updateAccountScrape(e.target[0].value,e.target[1].value,session?.user?.email,e.target[3].value)
  ...
  return(
    ...
    <form onSubmit={(e)=>{e.preventDefault(), submitData(e)}} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      <div className="mb-4">
        <label className="block text-gray-700 text-2xl font-bold mb-2" htmlFor="username">
          Username
        </label>
        <input className="shadow appearance-none border rounded w-full py-2 px-3 mb-7 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username/Email"/>
      </div>
      <div className="mb-6">
  ...
  <div className="flex items-center mb-10">
      <input checked id="default-radio-2" type="radio" value="ColumbusData" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
      ...
      <div className="flex flex-col items-center">
        ...
        <a className="inline-block align-baseline font-bold text-sm text-blue-500 mt-4 hover:text-blue-800" href="#">
          Forgot Password?
        </a>
      </div>
    </form>
